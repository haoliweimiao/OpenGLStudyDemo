 ...
 * @LastEditTime: 2019-07-27 20:16:11
 * @LastEditors: Please set LastEditors
 */

#include "DemoDrawTwoTranslate.hpp"

int demoFunDrawTwoTranslate()
{
    initOpenGL();

    // glfw window creation
    // --------------------
    GLFWwindow *window = glfwCreateWindow(WINDOW_WIEGHT, WINDOW_HEIGHT, WINDOW_NAME, NULL, NULL);
