 ...
 * @LastEditTime: 2019-07-27 20:16:14
 * @LastEditors: Please set LastEditors
 */
#include "DemoDrawTwoTriangle.hpp"

int demoFunDrawTwoTriangle() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    glDrawArrays(GL_TRIANGLES, 0, 6); // set the count to 6 since we're drawing
